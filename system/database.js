module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Instagram'
      if (!('sk_author' in setting)) setting.sk_author = '@terserah_bomat'
      ...
      if (!('cover' in setting)) setting.cover = 'https://i.ibb.co/sg279vz/girl-mask-cyborg-213508-1366x768-w'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/KBxslpQTy08Djs32qK2TJQ'
   } else {
      global.db.setting = {
         autodownload: false,
         chatbot: true,
         ...
         msg: 'Hi +tag \nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://i.ibb.co/sg279vz/girl-mask-cyborg-213508-1366x768-w',
         link: 'https://chat.whatsapp.com/KBxslpQTy08Djs32qK2TJQ'
      }
   }
}